...
#
# currline = ["^" in line for line in lines].index(True)
# currcol = lines[currline].index("^")
#
...
#             if lines[currline - 1][currcol] != "#":
#                 lines[currline - 1][currcol] = "^"
#                 lines[currline][currcol] = "X"
#                 currline -= 1
#             else:
#                 lines[currline][currcol] = right_turns[lines[currline][currcol]]
#         if lines[currline][currcol] == ">":
#             if lines[currline][currcol + 1] != "#":
#                 lines[currline][currcol + 1] = ">"
#                 lines[currline][currcol] = "X"
#                 currcol += 1
#             else:
#                 lines[currline][currcol] = right_turns[lines[currline][currcol]]
#         if lines[currline][currcol] == "v":
#             if lines[currline + 1][currcol] != "#":
#                 lines[currline + 1][currcol] = "v"
#                 lines[currline][currcol] = "X"
#                 currline += 1
#             else:
#                 lines[currline][currcol] = right_turns[lines[currline][currcol]]
...
#         flag = False
#
# flat = "".join(["".join(line) for line in lines])
# print("Part One: ", flat.count("X") + 1)
...
# 23.6 seconds on my computer.
print(f"{end-start} seconds taken to get the answer.")
# 6 times speedup.
